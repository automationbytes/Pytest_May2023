...
class HomePage:
    appLogo_webElement_classname = 'app_ogo'
    filter_select_classname = 'product_sort_container'
...
#        self.driver = webdriver.Chrome()
    ...
    def selectFilterDropdown(self,value):
        dropdown = Select(self.driver.find_element(By.CLASS_NAME,self.filter_select_classname))
